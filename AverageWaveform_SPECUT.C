...
void Analyse(int r, double range1, double range2, std::vector<int> triggerchannels,int NEvts=-1, string adc="DT5725")
{
  ...
  ana::Run_t myrun(r,{{Form("/pnfs/ciemat.es/data/neutrinos/SiPM_dune_IR02/Feb2021/ROOT/RUN%i_ch1.root",r),"ADC0"},{Form("/pnfs/ciemat.es/data/neutrinos/SiPM_dune_IR02/Feb2021/ROOT/RUN%i_ch2.root",r),"ADC1"},{Form("/pnfs/ciemat.es/data/neutrinos/SiPM_dune_IR02/Feb2021/ROOT/RUN%i_ch3.root",r),"ADC2"}},adc,range1, range2,30,1000);
...
//  myrun.SetCutTriggerWaveformCuts(triggerchannels);
  ...
  myrun.SetCutVariable("ChargeMaxPeakRange",2e-12,7e-12);
...
//{57,{0,1},-1}*/
 ...
 for (auto r : myvector)
 {
   if(r.run>1000) Analyse(r.run, 0.32e-6,0.39e-6,r.triggerChannels, r.Nevts);
